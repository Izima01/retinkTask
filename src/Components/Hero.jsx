  ...
  return (
    <section className="w-full h-64 relative">
        ...
        <div className="w-11/12 mx-auto lg:ml-7 lg:mr-12">
          <h1 className="text-3xl lg:text-5xl text-retink-grey font-semibold pt-6">Hey James!</h1>
          <p className="mt-1 lg:mt-2 font-medium lg:text-xl text-retink-grey mb-6 lg:mb-10">Lets create something awesome today <span>✨💫</span></p>

          <button onClick={() => setShowDialog(true)} className="border border-[#754DE8] text-[#754DE8] bg-white rounded-3xl py-1.5 px-6 grower">Start Creating</button>

          <div className="w-full relative top-4 shadow-md shadow-[#EBEAEF] rounded-xl lg:hidden">
